...
/*
Plugin name: Dugnadskalkulator Shortcode
Description: Makes a shortcode to put a dugnadscalculator anywhere on your page
...
function dugnad_script_reg(){
	...
	wp_register_script(
		'dugnadskalkulator',
		plugins_url('paal-dugnad').'/assets/script.js',
		array('jquery'),
		null,
		true
	);
    ...
    wp_register_style(
		'dugnadskalkulator',
		plugins_url('paal-dugnad').'/assets/style.css',
		null,
		null,
		'all'
	);
	    ...
	    <form oninput="updateRanges()" onchange="updateRanges()">  <!-- For IE--->       	                                        
            ...
            <div class="resultat-salgprodukter">Antall produkter å selge: <span>20</span> <br /></div>                                 
                ...
                <div class="calc-sammendrag">
                    ...
                    Fortjeneste pr. Produkt 70 Kr<br />
                    Anbefalt utsalgspris 130kr
               </div>
            </div>                           
	    </form>
	</div>
